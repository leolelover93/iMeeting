...
@Code
    ViewData("Title") = Resource.rese_EditTitle
    
    Dim requireValidation As Boolean = Not Model.ManualState ' True
...
<h2>@IIf(requireValidation, "Validation Réservation", Resource.rese_EditTitle)</h2>
...
@Using (Html.BeginForm())
    ...
    @Html.HiddenFor(Function(model) model.ID_RESERVATION)
         @Html.HiddenFor(Function(model) model.ManualState)
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="prof">
            ...
            <div class="form-group required-field">
                @Html.LabelFor(Function(model) model.DATE_FIN, Resource.rese_Plage, New With {.class = "control-label col-md-2"})
                <div class="col-md-2">
...
<div class="tab-pane" id="other">
                ...
                @If User.IsInRole("SCC") Then
                        ...
                        @<text>
                            ...
                            <div class="form-group">
                                @Html.LabelFor(Function(model) model.CurrentState, New With {.class = "control-label col-md-2"})
                                <div class="col-md-10">
                                    @Html.EditorFor(Function(model) model.CurrentState, "EtatCourant")
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-10">
                    @Code
                        Dim actionName = Resource.Edit
                        If Model.CurrentState = EnumCurrentState.CanceledPending Then
                            actionName = "Valider Annulation"
                        ElseIf Model.CurrentState = EnumCurrentState.ReportedPending Then
                            actionName = "Valider Report"
                        ElseIf Model.Etat <> EnumReservation.Confirmed Then
                            actionName = "Valider"
                        End If
                    End Code
                    <input type="submit" value="@actionName" class="btn btn-primary btn-sm" />
